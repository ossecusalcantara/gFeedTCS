...
@section('conteudo-view')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Edição de perguntas para avaliação de desempenho, preencha todas os campos.</h5>

            {!! Form::model( $question ,['route' => ['questions.update' , $question->id], 'method' => 'put', 'class' => 'row g-3',]) !!}
                <div class="col-md-4">
