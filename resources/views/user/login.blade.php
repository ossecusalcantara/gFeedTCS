...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/logo-gfeed.png" rel="icon">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            {!! Form::text('username', null, ['class' => 'form-control', 'id' => 'yourUsername', 'required']) !!}
                                    ...
                                    <div class="col-12">
                                        ...
                                        {!! Form::password('password', ['class' => 'form-control', 'id' => 'yourPassword', 'required']) !!}
