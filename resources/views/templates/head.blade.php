<head>
    ...
    <title>Dashboard - G-Feed</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ secure_asset('assets/img/logo-gfeed.png') }}" rel="icon">
    ...
    <link href="{{ secure_asset('assets/css/DataTables/datatables.css') }}" rel="stylesheet">
    <link href="{{ secure_asset('assets/css/DataTables/datatables.min.css') }}" rel="stylesheet">
